...
args=(
    ...
    #-drive file=${ISODIR}/FreeBSD-13.1-RELEASE-amd64-dvd1.iso,media=cdrom
    ...
    #-vga qxl
    #-spice port=5920,addr=127.0.0.1,disable-ticketing=on
    #-vga vmware
    #-device qxl-vga
    -device vmware-svga
    #-global qxl-vga.ram_size=262144
    #-global qxl-vga.vram_size=262144
    -global vmware-svga.vgamem_mb=246
    -display ${DP}
    ...
    -device intel-hda -device hda-duplex #,audiodev=sdl0
