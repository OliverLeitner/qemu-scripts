...
args=(
    ...
    #-drive file=${ISODIR}/bsd/NetBSD-9.3-amd64.iso,media=cdrom
    -drive id=drive0,file=${VMDIR}/${NETNAME}.qcow2.efi,media=disk,if=none,format=qcow2,cache=none,aio=io_uring,cache.direct=off
